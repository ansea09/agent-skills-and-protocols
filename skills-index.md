...
| --- | --- | --- | --- |
| [`fpf-work-guide`](skills/fpf-work-guide/) | Guide Codex toward more precise, traceable answers by validating current FPF context and applying FPF-backed protocols before substantive work. | FPF-backed reasoning, planning, review, coding, and source-backed answers. | Start with [`skills/fpf-work-guide/README.md`](skills/fpf-work-guide/README.md). Cross-platform shell entrypoints: Bash, PowerShell, and CMD wrappers. Requires `git` for refresh. Personal launchers/hooks are local automation, not a public skill overlay. |
...
| [`speech-to-md`](skills/speech-to-md/) | Convert trusted local speech recordings or existing transcripts into Markdown transcript bundles. | Lectures, interviews, meetings, podcasts, voice notes, timestamped transcript evidence, and LLM-readable audio analysis bundles. | Start with [`skills/speech-to-md/README.md`](skills/speech-to-md/README.md). Source-only public skill. Transcript import works without ASR. Local ASR requires user-installed `whisper.cpp` and a model path. No bundled ASR models, cloud credentials, private audio, or generated bundles. |
